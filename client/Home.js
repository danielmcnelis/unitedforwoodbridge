  ...
  return (
    <div className='content'>
      ...
      <div id='home-images' className='centered-row-flexbox'>
          <img id='home-pine' src='/images/pine.jpg' alt='large pine on walking path'/>
          <img id='home-maple' src='/images/maple.jpg' alt='large maple on walking path'/>
          <img id='home-ice' src='/images/ice.jpg' alt='frozen pond daytime landscape'/>
      </div>
      <p id='home-quote'>
