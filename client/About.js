...
const About = () => {
  ...
  return (
    <div className='content'>
      ...
      <img id='about-landscape' src='./images/landscape-3.png' alt='landscape'/>
      <div id='about-container'>
        ...
        <p id='about-summary-3'>
          If you're unconvinced, drive down with your family and walk the loop around the pond. Take in the fresh air and smell the needles of the hundred-year old pine trees. Keep your headphones in your pocket and listen to the wind rustling across the plains. And keep your eyes peeled for all manner of wildlife that have found a rare, new habitat in Southern Connecticut. We bet you'll agree this land has enormous value to the community.
        </p>
      </div>
    </div>
  )
